...
SUMMARISE_PROMPT = """You are a clinical assistant helping therapists understand patient conversations.
Read the conversation below and produce a structured summary.

You must respond ONLY in this exact JSON format, nothing else:
{
  "summary_kannada": "2-3 sentence summary in Kannada of what the person shared",
  "summary_english": "2-3 sentence summary in English of what the person shared",
  "key_concerns": ["concern1", "concern2"],
  "emotional_state": "brief description of emotional state in English",
